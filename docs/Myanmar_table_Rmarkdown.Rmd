...
Ayeyarwady <- filter(Myanmar, Region == "Ayeyarwady")
Bago <- filter(Myanmar, Region == "Bago")
Chin <- filter(Myanmar, Region == "Chin")
Kachin <- filter(Myanmar, Region == "Kachin")
Kayah <- filter(Myanmar, Region == "Kayah")
Magway <- filter(Myanmar, Region == "Magway")
Mandalay <- filter(Myanmar, Region == "Mandalay")
Mon <- filter(Myanmar, Region == "Mon")
Naypyitaw <- filter(Myanmar, Region == "Naypyitaw")
Sagaing <- filter(Myanmar, Region == "Sagaing")
Shan <- filter(Myanmar, Region == "Shan")
Tanintharyi <- filter(Myanmar, Region == "Tanintharyi")
Yangon <- filter(Myanmar, Region == "Yangon")
Rakhine <- filter(Myanmar, Region == "Rakhine")

#Sort table by Region and then district
Myanmar.sorted <- arrange(Myanmar, Region, District)
```
...
plotfun <- function(i) {
    ...
    township <- filter(Myanmar.sorted, ID == i)
    ...
    forest2000 <- as.character((sapply(township$treecover2000, km2_to_acre)))
...
for (i in (1:nrow(Myanmar.sorted))) {
  plot(plotfun(i))
}
```
